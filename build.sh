...
cd ..
g++ -shared -o libfieldml.so ./core/src/*.cpp -I/usr/lib/jvm/java-6-openjdk-amd64/include/ -Icore/src/ `pkg-config --cflags libxml-2.0` `pkg-config --libs libxml-2.0` jni/*.cxx -fPIC

...
static vector<ParameterWriter *> writers;

ParameterWriter *ParameterWriter::handleToWriter( FmlWriterHandle handle )
{
...
FmlWriterHandle ParameterWriter::addWriter( ParameterWriter *writer )
{
